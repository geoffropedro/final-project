B2.mgp.Booking.BlockedDateDialog = Ext.extend( Ext.Window, {
	...
	{
		this.itemPanel = new B2.mgp.Booking.BlockedDatePanel({
		...
		B2.mgp.Booking.BlockedDateDialog.superclass.initComponent.call( this );
	},
